  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0a0a0a] text-white selection:bg-indigo-500/30">
      <main className="relative flex w-full max-w-5xl flex-col items-center gap-12 px-6 py-20 text-center">
        ...
        <div className="absolute -bottom-40 right-0 -z-10 h-[400px] w-[400px] rounded-full bg-purple-600/10 blur-[100px]" />

        <div className="flex flex-col items-center gap-4">
          <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-sm font-medium text-indigo-300">
        ...
        <div className="grid w-full grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div key={i} className="group relative rounded-2xl border border-white/5 bg-white/[0.02] p-8 text-left transition-all hover:bg-white/[0.05]">
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          ...
          <a
            ...
            className="flex h-12 items-center justify-center rounded-xl border border-white/10 bg-white/5 px-8 font-semibold transition-all hover:bg-white/10"
          >
            Documentation
          </a>
        </div>
